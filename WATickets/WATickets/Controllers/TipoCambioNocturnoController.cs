...
{
    public class TipoCambioNocturnoController : ApiController
    {
        G G = new G();
                ...
                try
                {
                    ...
                    if (response3.IsSuccessStatusCode)
                    {
                        ...
                        try
                        {
                            ...
                            DateTime FechaAct = respZoho.venta_date;

                            if(FechaAct.Date == DateTime.Now.Date)
                            {
                            ...
                            {
                                throw new Exception("No se pudo insertar el tipo de cambio, por la fecha. -> " + FechaAct.ToString());
                            }
